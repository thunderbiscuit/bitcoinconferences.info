...
1. Open a PR adding an entry to the YAML file for the corresponding year in `data/` (e.g. `data/2026.yaml`) with the following structure (date: YYYY-MM-DD):
...
Entries within a file are kept in chronological order.
